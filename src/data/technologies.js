// Front-End
import css from '@img/img-logo/css3.svg';
import html from '@img/img-logo/html5.svg';
...
export const Technologies = {
    ...
    // Backend
       ...
       MongoDB: { name: 'MongoDB', img: mongodb },
       MySQL: { name: 'MySQL', img: mysql },
       PHP: { name: 'PHP', img: php },
       Symfony: { name: 'Symfony', img: symfony },
       
    // Outils & Plateformes
       GitHub: { name: 'GitHub', img: github },
       OpenAI: { name: 'OpenAI', img: openai },
       WordPress: { name: 'WordPress', img: wordpress},
       Figma: { name: 'Figma', img: figma },
       Render: { name: 'Render', img: render },
       Alwaysdata: { name: 'Alwaysdata', img: alwaysdata },    
