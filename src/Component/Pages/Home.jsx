                ...
                <main className='main pb-1'> 
                    ...
                    <div className='about_home my-5 d-flex flex-column justify-content-center align-items-center'>
                        ...
                        <div className='card-text d-flex flex-row justify-content-around pt-3'>
                                ...
                                <p className='text text-start text-wrap w-75  align-content-center fst-italic'>
                                Je suis un <strong className='text-strong'>développeur web & mobile Full Stack</strong>.  
                    ...
                    <div className='actual my-5'>    
                        ...
                        <div className='card-text d-flex flex-column justify-content-center align-content-center py-2'>
                            ...
                            Formation <strong className='text-strong'>Développeur Web & Mobile Full Stack </strong> 
                            suivie au <strong className='text-strong'>Centre Européen de Formation</strong>, terminée et en attente de l’examen.  
                            <br /><br />
                            Un <strong className='text-strong'>stage en entreprise</strong> est prévu à partir de 
                            <strong className='text-strong'> octobre 2025</strong> pour une durée de <strong className='text-strong'>350 heures</strong>, 
                            pouvant être réparties en plusieurs périodes, afin de valider la formation 
                            et présenter l’examen final.
                            </p>
                        </div>
                        <div className='icons-home d-flex flex-row justify-content-center align-content-center pb-2'>
                    ...
                    <div className='portfolio my-5'>
                        <h3 className='subtitle text-center py-4'>Mes projets</h3>
                        <div>
                            <Carousel/>
                        </div>
                    </div>
