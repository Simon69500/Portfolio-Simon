...
const StackCard = () => {
  return (
    <article
      className="h-full flex flex-col gap-4 p-6 rounded-3xl border border-gray-100 dark:border-gray-800 bg-bento-light dark:bg-bento-dark md:col-span-4 order-2 transition-all duration-300 hover:scale-105 hover:border-accent-primary dark:hover:border-accent-primary"
    >
      {/* 
