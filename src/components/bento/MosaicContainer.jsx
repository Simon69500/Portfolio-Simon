...
const MosaicContainer = ({ projects, expansionProjetId, setExpansionProjetId }) => {
    return (
        <div className="h-full p-6 rounded-3xl bg-bento-light dark:bg-bento-dark shadow-sm transition-all duration-300 hover:scale-[1.02] border border-transparent hover:border-accent-primary">
